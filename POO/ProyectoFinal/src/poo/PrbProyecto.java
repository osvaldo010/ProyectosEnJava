...
public class PrbProyecto
{
    ...
    public static void main(String[] args)
    {
        String mnu[] =
        {
            "Registro de Alumnos", "Registro de Peronal", "Modificaciones de Alumnos o Personal", "Consultas Alumnos o Personal", "Historial Clinico", "Reportes ", "Salir"
        };
        ...
        String mnu5[] =
        {
            "Alergias", "Sobrepeso", "Diabetes", "Desnutricion", "Obesidad", "Otros", "Mayor frecuencia de citas", "Menor frecuencia de citas", "Regresar"
        };
...
//        datos =(DatosGenerales[]) .cargaArr(null,"Productos.dat");
        do
        {
            ...
            switch (opc)
            {
                ...
                case 3:
                    ...
                    {
                        case 1:
                            System.out.println("Ingresa el cve del alumno: ");
...
//        ManipulacionArchivos.guarda(null,datos, "Productos.dat");
    }
}
