 ...
 * @author USUARIO
 */
public class RepMyrFrecPers extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepMyrFrecPers()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Personal Mayor Frecuencia");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepMyrFrecPers().setVisible(true);
            }
        });
    }
