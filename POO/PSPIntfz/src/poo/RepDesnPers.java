 ...
 * @author USUARIO
 */
public class RepDesnPers extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal con Desnutrición");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf3 plantilla = new PlantillaPdf3("Reportes Desnutricion Personal", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepDesnPers().setVisible(true);
            }
        });
    }
