 ...
 * @author USUARIO
 */
public class RepDiabAlumH extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Hombres con Diabetes");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf4Sx plantilla = new PlantillaPdf4Sx("Reportes Diabetes Alumnos", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepDiabAlumH().setVisible(true);
            }
        });
    }
