 ...
 * @author USUARIO
 */
public class RepAlumHom extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Hombres");
        ...
        if (almsH.getColumnModel().getColumnCount() > 0)
        {
            ...
            almsH.getColumnModel().getColumn(0).setPreferredWidth(15);
            ...
            almsH.getColumnModel().getColumn(3).setPreferredWidth(30);
            almsH.getColumnModel().getColumn(4).setResizable(false);
            almsH.getColumnModel().getColumn(4).setPreferredWidth(15);
            almsH.getColumnModel().getColumn(5).setResizable(false);
            almsH.getColumnModel().getColumn(5).setPreferredWidth(15);
            almsH.getColumnModel().getColumn(6).setResizable(false);
            almsH.getColumnModel().getColumn(6).setPreferredWidth(15);
            almsH.getColumnModel().getColumn(7).setResizable(false);
            almsH.getColumnModel().getColumn(7).setPreferredWidth(15);
            almsH.getColumnModel().getColumn(8).setResizable(false);
            almsH.getColumnModel().getColumn(8).setPreferredWidth(15);
        }
    ...
    {//GEN-HEADEREND:event_formWindowActivated
        JPanelImage iconoA = new JPanelImage(iconEd, "img/hombre.png");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepAlumHom().setVisible(true);
            }
        });
    }
