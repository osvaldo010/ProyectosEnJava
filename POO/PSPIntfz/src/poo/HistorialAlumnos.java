...
public class HistorialAlumnos extends javax.swing.JFrame
{
    ...
    {//GEN-HEADEREND:event_cancelarActionPerformed
        ManipulacionArchivos.guardaMatriz(this, SelectHistorial.historiales, "Historiales.dat");
    ...
    {//GEN-HEADEREND:event_aceptarActionPerformed
        ...
        try
        {
            ...
            {
                if (dat[posicion] instanceof Alumnos)
                {
...
//                        hist = Manipulacion.insertaHistorialRenglon(hist);
                        ...
                        hist = new HistorialClinico[dat.length][];
...
//                            hist = Manipulacion.insertaHistorialRenglon(hist);
                    ...
                    CtrlInterfaz.limpia(cve, nombre, apPaterno, apMaterno, sexoField, carreraField, viveConField, padActual, antPers, medicamentos, planTratamiento, otrasEspField);
                    ...
                    SelectHistorial.historiales = hist;
                }
            }
        } catch (Exception e)
        {
            if (SelectRegistro.datos == null)
            {
                ...
                dispose();
            } else if (posicion > hist.length || posicion < 0 || dat[posicion] instanceof Personal)
            {
                Mensaje.error(this, "Clave no encontrada");
                cve.setText("");
            } else
            {
    ...
    {//GEN-HEADEREND:event_borrarActionPerformed
        CtrlInterfaz.limpia(cve, nombre, apMaterno, apPaterno, sexoField, carreraField, viveConField, otrasEspField);
        ...
        carreraField.setText(null);
        viveConField.setText(null);
        CtrlInterfaz.cambia(cve);
