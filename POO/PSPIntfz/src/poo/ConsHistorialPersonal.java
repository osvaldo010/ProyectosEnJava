 ...
 * @author USUARIO
 */
public class ConsHistorialPersonal extends javax.swing.JFrame
{
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(obesidad, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    {//GEN-HEADEREND:event_cveKeyPressed
            ...
            if (evt.getKeyChar() == '\n')
            {
                ...
                for (int i = 0; i < hist.length; i++)
                {
                    if (hist[i][0].getClave() == cve.getText())
                    {
                        ...
                        if (pos != -1)
                        {
                            if (datos[pos].getCve().equals(cve.getText()) && SelectRegistro.datos[pos] instanceof Personal)
                            {
                                String sexoSt;
                                ...
                                String est;
                                if (((Personal) datos[pos]).getEstatus() == 'B')
                                {
                                    est = "Base";
                                } else
                                {
                            ...
                            } else if (SelectRegistro.datos[pos] instanceof Alumnos)
                            {
        ...
        {
            if (SelectRegistro.datos == null || hist == null)
            {
