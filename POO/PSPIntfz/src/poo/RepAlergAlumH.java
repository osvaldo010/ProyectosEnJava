 ...
 * @author USUARIO
 */
public class RepAlergAlumH extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepAlergAlumH()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Hombres con Alergias");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf4Sx plantilla = new PlantillaPdf4Sx("Reportes Alergias Alumnos Hombres", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepAlergAlumH().setVisible(true);
            }
        });
    }
