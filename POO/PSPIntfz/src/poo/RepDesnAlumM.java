 ...
 * @author USUARIO
 */
public class RepDesnAlumM extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Mujeres con Desnutrición");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf4Sx plantilla = new PlantillaPdf4Sx("Reportes Desnutricion Alumnos", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepDesnAlumM().setVisible(true);
            }
        });
    }
