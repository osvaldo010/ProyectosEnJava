 ...
 * @author USUARIO
 */
public class RepMnrFrecPersM extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepMnrFrecPersM()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("P. Mujeres Menor Frecuencia");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepMnrFrecPersM().setVisible(true);
            }
        });
    }
