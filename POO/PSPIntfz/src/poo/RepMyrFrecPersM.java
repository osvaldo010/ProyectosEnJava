 ...
 * @author USUARIO
 */
public class RepMyrFrecPersM extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepMyrFrecPersM()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("P. Mujeres Mayor Frecuencia");
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        try
        {
            ...
            if (hist != null)
            {
                ...
                {
                    if (hist[i] != null && hist[i].length > longitudMaxima && dat[i] instanceof Personal)
                    {
            ...
            for (int i = 0; i < hist.length; i++)
            {
                if (hist[i].length == longitudMaxima && dat[i] instanceof Personal)
                {
                    if (dat[i].getSexo() == 'M')
                    {
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepMyrFrecPersM().setVisible(true);
            }
        });
    }
