 ...
 * @author USUARIO
 */
public class RepObsdAlumM extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Mujeres con Obesidad");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf4Sx plantilla = new PlantillaPdf4Sx("Reportes Obesidad Alumnos", fechaString);
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 3, 2);
    ...
    {//GEN-HEADEREND:event_formWindowActivated
        JPanelImage iconoA = new JPanelImage(iconEd, "img/ritmo-cardiaco.png");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepObsdAlumM().setVisible(true);
            }
        });
    }
