 ...
 * @author USUARIO
 */
public class RepDesnPersH extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal Hombres Desnutrición");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 1, 1);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepDesnPersH().setVisible(true);
            }
        });
    }
