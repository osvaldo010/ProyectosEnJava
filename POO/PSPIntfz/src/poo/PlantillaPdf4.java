 ...
 * @author Luis Ramirez
 */
public class PlantillaPdf4 extends javax.swing.JFrame
{
    ...
    public PlantillaPdf4(String reporte, String fecha)
    {
    ...
    public void crearPlantilla(DatosGenerales[] datos, JLabel tituloA, int padecimiento)
    {
        try
        {
            ...
            for (int i = 0; i < datos.length; i++)
            {
                if (datos[i] instanceof Alumnos)
                {
                    ...
                    String conv = null;
                    switch (((Alumnos) datos[i]).getViveCon())
                    {
                        case 0:
                            conv = "Mamá y Papá";
                            break;
