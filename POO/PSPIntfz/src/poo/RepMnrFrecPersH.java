 ...
 * @author USUARIO
 */
public class RepMnrFrecPersH extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepMnrFrecPersH()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("P. Hombres Menor Frecuencia");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepMnrFrecPersH().setVisible(true);
            }
        });
    }
