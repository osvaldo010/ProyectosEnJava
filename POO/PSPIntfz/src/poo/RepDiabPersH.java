 ...
 * @author USUARIO
 */
public class RepDiabPersH extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal Hombres con Diabetes");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 2, 1);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepDiabPersH().setVisible(true);
            }
        });
    }
