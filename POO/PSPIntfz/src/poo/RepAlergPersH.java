 ...
 * @author USUARIO
 */
public class RepAlergPersH extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepAlergPersH()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal Hombres con Alergias");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf3Sx plantilla = new PlantillaPdf3Sx("Reportes Alergias Personal Hombres", fechaString);
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 0, 1);
    ...
    {//GEN-HEADEREND:event_formWindowActivated
        JPanelImage iconoA = new JPanelImage(iconEd, "img/enfermedad.png");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepAlergPersH().setVisible(true);
            }
        });
    }
