 ...
 * @author USUARIO
 */
public class RepAlergPersM extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepAlergPersM()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal Mujeres con Alergias");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf3Sx plantilla = new PlantillaPdf3Sx("Reportes Alergias Personal Mujeres", fechaString);
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 0, 2);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepAlergPersM().setVisible(true);
            }
        });
    }
