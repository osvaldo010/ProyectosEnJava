 ...
 * @author USUARIO
 */
public class RepOtrosAlumH extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepOtrosAlumH()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("A. Hombres con Otros Padecimientos");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepOtrosAlumH().setVisible(true);
            }
        });
    }
