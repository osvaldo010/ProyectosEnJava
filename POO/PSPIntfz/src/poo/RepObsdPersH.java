 ...
 * @author USUARIO
 */
public class RepObsdPersH extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("P. Hombres con Obesidad");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf3Sx plantilla = new PlantillaPdf3Sx("Reportes Obesidad Personal", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepObsdPersH().setVisible(true);
            }
        });
    }
