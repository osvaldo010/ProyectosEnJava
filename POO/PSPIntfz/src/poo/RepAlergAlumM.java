 ...
 * @author USUARIO
 */
public class RepAlergAlumM extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepAlergAlumM()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Mujeres con Alergias");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf4Sx plantilla = new PlantillaPdf4Sx("Reportes Alergias Alumnos Mujeres", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepAlergAlumM().setVisible(true);
            }
        });
    }
