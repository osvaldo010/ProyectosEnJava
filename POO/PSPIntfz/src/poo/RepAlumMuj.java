 ...
 * @author USUARIO
 */
public class RepAlumMuj extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Mujeres");
        ...
        almsM.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][]
            {
            ...
            new String []
            {
                "CVE", "Nombre Completo", "Carrera", "Convivencia", "Alergias", "Diabetes", "Desnutricion", "Sobrepeso", "Obesidad"
            }
        )
        {
        ...
        almsM.setShowGrid(true);
        jScrollPane1.setViewportView(almsM);
        if (almsM.getColumnModel().getColumnCount() > 0)
        {
            almsM.getColumnModel().getColumn(0).setResizable(false);
            almsM.getColumnModel().getColumn(0).setPreferredWidth(15);
            almsM.getColumnModel().getColumn(1).setResizable(false);
            almsM.getColumnModel().getColumn(2).setResizable(false);
            almsM.getColumnModel().getColumn(2).setPreferredWidth(50);
            almsM.getColumnModel().getColumn(3).setResizable(false);
            almsM.getColumnModel().getColumn(3).setPreferredWidth(30);
            almsM.getColumnModel().getColumn(4).setResizable(false);
            almsM.getColumnModel().getColumn(4).setPreferredWidth(15);
            almsM.getColumnModel().getColumn(5).setResizable(false);
            almsM.getColumnModel().getColumn(5).setPreferredWidth(15);
            almsM.getColumnModel().getColumn(6).setResizable(false);
            almsM.getColumnModel().getColumn(6).setPreferredWidth(15);
            almsM.getColumnModel().getColumn(7).setResizable(false);
            almsM.getColumnModel().getColumn(7).setPreferredWidth(15);
            almsM.getColumnModel().getColumn(8).setResizable(false);
            almsM.getColumnModel().getColumn(8).setPreferredWidth(15);
        }
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        try
        {
            ...
            DefaultTableModel modelo = (DefaultTableModel) almsM.getModel();
            ...
            for (int i = 0; i < dat.length; i++)
            {
                if (dat[i] instanceof Alumnos)
                {
                    if (dat[i].getSexo() == 'M')
                    {
                        ...
                        String[] fila =
                        {
                            cve, nomC, carr, conv, alerg, diab, desn, sp, obsd
                        };
                        modelo.addRow(fila);
                    }
                }
    ...
    {//GEN-HEADEREND:event_formWindowActivated
        JPanelImage iconoA = new JPanelImage(iconEd, "img/mujer.png");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf9Sx plantilla = new PlantillaPdf9Sx("Reportes Alergias Personal Mujeres", fechaString);
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 2);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepAlumMuj().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable almsM;
