 ...
 * @author USUARIO
 */
public class SelectReporteAlergias extends javax.swing.JFrame
{

    /**
     * Creates new form ReporteHombres
     */
    public SelectReporteAlergias()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        registroPersonal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/poo/img/maestro.png"))); // NOI18N
        ...
        registroAlumnos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/poo/img/alumnos.png"))); // NOI18N
    ...
    {//GEN-HEADEREND:event_registroPersonalActionPerformed
        new RepAlergPers().setVisible(true);
        dispose();
    ...
    {//GEN-HEADEREND:event_registroAlumnosActionPerformed
        new RepAlergAlum().setVisible(true);
        dispose();
