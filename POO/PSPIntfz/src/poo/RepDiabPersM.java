 ...
 * @author USUARIO
 */
public class RepDiabPersM extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal Mujeres con Diabetes");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf3Sx plantilla = new PlantillaPdf3Sx("Reportes Diabetes Personal", fechaString);
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 2, 2);
    ...
    {//GEN-HEADEREND:event_formWindowActivated
        JPanelImage iconoA = new JPanelImage(iconEd, "img/capsulas.png");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepDiabPersM().setVisible(true);
            }
        });
    }
