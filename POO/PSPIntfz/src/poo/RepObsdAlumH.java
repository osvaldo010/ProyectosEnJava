 ...
 * @author USUARIO
 */
public class RepObsdAlumH extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Hombres con Obesidad");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 3, 1);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepObsdAlumH().setVisible(true);
            }
        });
    }
