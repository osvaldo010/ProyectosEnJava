 ...
 * @author USUARIO
 */
public class SelectRegistro extends javax.swing.JFrame
{

    public static DatosGenerales datos[] = null;

    /**
     * Creates new form SeleccionRegistro
     */
    public SelectRegistro()
    {
        initComponents();
    }
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        ...
        try
        {
            datos = (DatosGenerales[]) ManipulacionArchivos.carga(this, "Datos.dat");
        } catch (Exception e)
        {
            if (datos == null)
            {
    ...
    {//GEN-HEADEREND:event_formWindowClosing
        new SelectOption().setVisible(true);
        ManipulacionArchivos.guarda(this, datos, "Datos.dat");
