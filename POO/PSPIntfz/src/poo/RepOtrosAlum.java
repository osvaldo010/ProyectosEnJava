 ...
 * @author USUARIO
 */
public class RepOtrosAlum extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos con Otros Padecimientos");
        ...
        almsH.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "CVE", "Nombre Completo", "Carrera", "Convivencia", "Padecimiento"
            }
        )
        {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pdfGenerate, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            for (int i = 0; i < dat.length; i++)
            {
                if (dat[i] instanceof Alumnos)
                {
                    if (dat[i].getOtras().length() > 0)
                    {
                        ...
                        String ots = dat[i].getOtras();

                        String[] fila =
                        {
                            cve, nomC, carr, conv, ots
                        };
                        modelo.addRow(fila);
                    }
                }
    ...
    {//GEN-HEADEREND:event_formWindowActivated
        JPanelImage iconoA = new JPanelImage(iconEd, "img/estetoscopio.png");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf4 plantilla = new PlantillaPdf4("Reportes Obesidad Alumnos", fechaString);
        plantilla.crearPlantilla(SelectRegistro.datos, titulo, 3);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepOtrosAlum().setVisible(true);
            }
        });
    }
