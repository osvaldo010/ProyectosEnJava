 ...
 * @author USUARIO
 */
public class RepMnrFrecAlumM extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepMnrFrecAlumM()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Alumnos Mujeres Menor Frecuencia");
    ...
    {//GEN-HEADEREND:event_formWindowOpened
        try
        {
            ...
            if (hist != null)
            {
                ...
                {
                    if (hist[i] != null && hist[i].length < minLongitud && dat[i] instanceof Alumnos)
                    {
            ...
            for (int i = 0; i < hist.length; i++)
            {
                if (hist.length <= minLongitud && dat[i] instanceof Alumnos)
                {
                    if (dat[i].getSexo() == 'M')
                    {
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepMnrFrecAlumM().setVisible(true);
            }
        });
    }
