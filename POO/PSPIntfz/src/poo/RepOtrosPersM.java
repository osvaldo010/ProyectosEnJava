 ...
 * @author USUARIO
 */
public class RepOtrosPersM extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepOtrosPersM()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("P. Mujeres Otros Padecimientos");
        ...
        almsH.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "CVE", "Nombre Completo", "Estatus", "Padecimiento"
            }
        )
        {
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepOtrosPersM().setVisible(true);
            }
        });
    }
