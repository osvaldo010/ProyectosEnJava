 ...
 * @author USUARIO
 */
public class RepSbpsAlumH extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Alumnos Hombres con Sobrepeso");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf4 plantilla = new PlantillaPdf4("Reportes Diabetes Alumnos", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepSbpsAlumH().setVisible(true);
            }
        });
    }
