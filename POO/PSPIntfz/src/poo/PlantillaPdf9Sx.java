 ...
 * @author Luis Ramirez
 */
public class PlantillaPdf9Sx extends javax.swing.JFrame
{
    ...
    public PlantillaPdf9Sx(String reporte, String fecha)
    {
    ...
    public void crearPlantilla(DatosGenerales[] datos, JLabel tituloA, int sx)
    {
        try
        {
