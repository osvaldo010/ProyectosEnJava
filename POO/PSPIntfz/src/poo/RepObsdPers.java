 ...
 * @author USUARIO
 */
public class RepObsdPers extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal con Obesidad");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf3 plantilla = new PlantillaPdf3("Reportes Obesidad Personal", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepObsdPers().setVisible(true);
            }
        });
    }
