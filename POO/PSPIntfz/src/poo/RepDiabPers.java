 ...
 * @author USUARIO
 */
public class RepDiabPers extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        titulo.setText("Personal con Diabetes");
    ...
    {//GEN-HEADEREND:event_pdfGenerateActionPerformed
        ...
        PlantillaPdf3 plantilla = new PlantillaPdf3("Reportes Diabetes Personal", fechaString);
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepDiabPers().setVisible(true);
            }
        });
    }
