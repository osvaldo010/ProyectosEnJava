 ...
 * @author USUARIO
 */
public class SelectHistorial extends javax.swing.JFrame
{
    public static DatosGenerales dat[] = (DatosGenerales[]) ManipulacionArchivos.carga(null, "Datos.dat");
    public static HistorialClinico[][] historiales = new HistorialClinico[dat.length][];;

    /**
     * Creates new form SelectHistorial
     */
    public SelectHistorial()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        setTitle("Selección de Historial");
        setResizable(false);
