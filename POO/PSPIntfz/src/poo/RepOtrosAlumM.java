 ...
 * @author USUARIO
 */
public class RepOtrosAlumM extends javax.swing.JFrame
{

    /**
     * Creates new form RepAlumHom
     */
    public RepOtrosAlumM()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("A. Mujeres con Otros Padecimientos");
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new RepOtrosAlumM().setVisible(true);
            }
        });
    }
