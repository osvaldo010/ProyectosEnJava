...
public class DatosGenerales implements Serializable
{
    ...
    public DatosGenerales(String cve, String nom, String primerAp, String segundoAp, char sexo, boolean desnutricion, boolean sobrepeso, boolean alergias, boolean obesidad, boolean diabetes, String otras)
    {
        this.cve = cve;
        this.nom = nom;
